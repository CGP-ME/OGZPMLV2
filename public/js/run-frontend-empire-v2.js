...
(function (OGZ) {
    ...
    const MODULES = [
        ...
        { name: 'Intelligence', script: '/js/panels/bot-intelligence.js', exportName: 'Intelligence' },
        ...
        { name: 'GoalTracker', script: '/js/panels/goal-tracker.js', exportName: 'GoalTracker' },

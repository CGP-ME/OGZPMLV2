...
(function (OGZ) {
    ...
    const TRACE_EVENTS_FOR_REPORT = new Set([
        ...
        'EXECUTE_HANDOFF',
        'EXECUTE_RETURN',
        'EXIT_INTENT_OPEN_ORDER_CONFIRMED',
        'EXIT_INTENT_RECONCILE_UNAVAILABLE',
        'EXIT_INTENT_RECONCILIATION_REQUIRED',
        'EXIT_ONLY_START',
        'EXIT_PENDING_BROKER_CONFIRMATION',
        'EXIT_PENDING_BROKER_FLAT_CONFIRMATION',
        'EXIT_RAIL_DESYNC_FLATTEN_HALT',
        'GAP_BACKFILL_REPLAY',
        ...
        'STATE_MUTATION',
        'STRATEGY_DECISION',
        'TTP_STALE_DATA_QUARANTINE',
        'WEBHOOK_ACCEPTED_WITHOUT_ORDER_ID',

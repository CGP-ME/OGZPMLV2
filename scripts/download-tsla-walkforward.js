#!/usr/bin/env node
/**
 * Download TSLA 15m walkforward data from Polygon.io
 * Date range: Feb 4 2026 - Apr 17 2026 (post-training, whatever is currently available)
 * Purpose: Out-of-sample post-training validation
 * Training window was: Mar 19 2024 - Feb 3 2026 (tsla-15m-2y.json)
 * NOTE: This is ~73 days, not a full year — all forward-in-time data available as of pull date.
 */
...
const OUTPUT_FILE = path.join(__dirname, '../tuning/15m-tsla-1yr-walkforward.json');

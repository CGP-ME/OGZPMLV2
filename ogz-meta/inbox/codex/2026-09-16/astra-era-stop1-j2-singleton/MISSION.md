...
6. The startup/setup launcher no longer deletes the established owner record; stale recovery remains exclusively owned by `SingletonLock`.
...
- every race contender is ready before a shared start signal, and the winner retains ownership until all five refusal outcomes are known;
- the startup launcher contains no direct deletion of the established owner record.

# STOP 1 J2 inherited boundary

J1 early reporting is closed. J2 changes only singleton acquisition and the evidence needed to prove it.

J3 retains:

- runner-owned SIGINT/SIGTERM shutdown;
- removal of SingletonLock's competing immediate signal/fatal exits;
- awaited final release and terminal status;
- actual initialized-process signal receipts.

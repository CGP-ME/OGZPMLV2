...
const ids=new Set();
for(const label of ['rsi-connection-preflight','rsi-connection-candidate','rsi-ui-final','rsi-connection-recheck']){
...
if(runIds.length!==3)throw new Error('Supply the three explicit review run IDs');
...
for(const name of ['blast.json','baseline-O5gGIe/receipt.json','baseline-O5gGIe/console.json','candidate-xCm6Jm/receipt.json',
  'final-tYEEcn/receipt.json','final-tYEEcn/console.json','final-NPWMmU/receipt.json','final-NPWMmU/console.json']){

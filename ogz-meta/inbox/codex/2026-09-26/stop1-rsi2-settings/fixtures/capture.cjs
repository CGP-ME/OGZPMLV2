...
const diff=cp.execFileSync('git',['diff','--binary','--','modules/RSI2MeanReversion.js','core/StrategyOrchestrator.js','foundation/ConfigLoader.js'],{cwd:clone,maxBuffer:4e6});

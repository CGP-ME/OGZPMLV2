...
const diff=cp.execFileSync('git',['diff','--binary','--','modules/PropSafeEMAPullback.js','core/StrategyOrchestrator.js','foundation/ConfigLoader.js'],{cwd:clone,maxBuffer:4e6});

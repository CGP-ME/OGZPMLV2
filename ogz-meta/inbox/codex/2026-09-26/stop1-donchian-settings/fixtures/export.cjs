...
const ids=new Set();
for(const label of ['donchian-settings-preflight','donchian-settings-candidate']){
...
for(const name of ['blast.json','baseline-74El8J/receipt.json','baseline-74El8J/console.json','candidate-BRs1XI/receipt.json','candidate-BRs1XI/console.json','candidate-TGETFq/receipt.json','candidate-TGETFq/console.json']){

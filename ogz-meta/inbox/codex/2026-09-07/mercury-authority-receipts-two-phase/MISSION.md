...
Dispatcher and ruling authority: Trey, Sept. 7, 2026.
...
9. **Default mode for audit questions** is agentic; single-shot stays available only by explicit flag. (Trey's call whether to flip the default globally; the executor lists what else depends on single-shot before flipping.)
...
**WHAT I ASSUMED:** the Sept 7 ledger lines 17 and 20 are replayable as written; the executor confirms before using them as the proof runs. one tweak

...
| `scope.backtest_report.scope_contract` | Scope | `BacktestRecorder` rejects missing or stale report-row scope before balance/row mutation, and `BacktestRunner` refuses to write reports containing unscoped rows. |

...
function buildFinalReviewLedgerSummary(finalReview) {
  ...
  return {
    ...
    identity_posture: finalReview.identityPosture || null,
...
function buildDirectQuestionLedgerEntry({
  ...
  iterations = null,
  iterationLimit = null,
  decisionSteerIteration = null,
  decisionSteerSentAt = null,
  termination = null,
  startedAt = new Date(),
  finishedAt = new Date(),
  error = null,
  ...
  const entry = sanitizeForLedger({
    ...
    loop_policy: {
      ...
      decision_steer_iteration: decisionSteerIteration,
      decision_steer_sent_at: decisionSteerSentAt,
    },

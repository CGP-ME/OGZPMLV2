...
class FibonacciDetector {
  ...
  getSuggestion(price, timeframe = 'primary') {
    ...
    // CHANGE 612: Fix trend mismatch - handle both 'up' and 'uptrend' formats
    if (this.state.trend === 'up' || this.state.trend === 'uptrend') {
    ...
    } else if (this.state.trend === 'down' || this.state.trend === 'downtrend') {
